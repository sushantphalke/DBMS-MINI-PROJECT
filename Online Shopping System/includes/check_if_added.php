...
function check_if_added_to_cart($product_id) {
    ...
    // We will select all the entries from the user_products table where the product_id is equal to the product_id we passed to this function, user_id is equal to the user_id in the session and status is 'Added to cart'
